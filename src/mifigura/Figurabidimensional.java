...
public class Figurabidimensional extends Figura {
	...
	public Figurabidimensional (int x1, int y1, int x2, int y2, boolean isFilled, Paint paint, Stroke stroke) {
		super (x1, y1, x2, y2, paint, stroke);
		setFillable (isFilled);
	}
	
	public Figurabidimensional (int x, int y, boolean isFilled, Paint paint, Stroke stroke) {
